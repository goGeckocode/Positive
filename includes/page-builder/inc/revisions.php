 ...
 * @param $post
 */
function positive_panels_revisions_save_post( $post_id, $post ) {
...
add_action( 'save_post', 'positive_panels_revisions_save_post', 11, 2 );
 ...
 * @param $revision_id
 */
function positive_panels_revisions_restore( $post_id, $revision_id ) {
...
add_action( 'wp_restore_post_revision', 'positive_panels_revisions_restore', 10, 2 );
 ...
 * @return mixed
 */
function positive_panels_revisions_fields( $fields ) {
	...
	$fields['panels_data_field'] = __('Page Builder Content', 'positive-backend');
	return $fields;

}
add_filter( '_wp_post_revision_fields', 'positive_panels_revisions_fields' );
 ...
 * @return string
 */
function positive_panels_revisions_field( $value, $field, $revision ) {
	...
	return positive_panels_render($parent_id, $panels_data);
}
add_filter( '_wp_post_revision_field_panels_data_field', 'positive_panels_revisions_field', 10, 3 );

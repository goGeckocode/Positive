...
( function($){
        ...
        var deleteFunction = function () {
            ...
            panels.undoManager.register(
                ...
                function(type, data, container, position){
                    ...
                    panels.addPanel(panel, container, false, position);
        ...
        panel.find('.title .actions')
            ...
            .append(
                $('<a class="duplicate">'+ panels.i10n.buttons.duplicate +'<a>').click(function(){
                    ...
                    window.panels.addPanel(duplicatePanel, panel.closest('.panels-container'), true);
     ...
     * @param bool openEditor Should we animate the panel
     */
    panels.addPanel = function(panel, container, openEditor, position){
        ...
        if(openEditor) panel.find('a.edit').click();
    }
        ...
        return $(this).each(function(){
            if( typeof data != 'undefined' ) {
                if( typeof data.title != 'undefined'){
                    ...
                    // si antes habia un valor en el titulo y ahora se ha borrado
                    } else {
                        $(this).find('h4 strong').text('');
                    }
